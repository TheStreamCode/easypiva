        ...
        <motion.div variants={itemVariants} className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-6">
            <div className="space-y-3">
              <Label
                htmlFor="nettoMensile"
                className="text-lg font-medium text-zinc-900 dark:text-zinc-100"
              >
                Netto Mensile Desiderato (€)
              </Label>
              <Input
                id="nettoMensile"
                type="number"
              ...
              <p className="text-sm text-zinc-500">
                ...
                <span className="font-medium text-zinc-700 dark:text-zinc-300">
                  {formatCurrency(result.nettoAnnuo)}
                </span>
              </p>
            </div>
          ...
          <div className="flex flex-col gap-6 p-6 rounded-xl bg-zinc-50 dark:bg-zinc-900/50 ring-1 ring-zinc-200 dark:ring-zinc-800">
            ...
            <div className="space-y-4 text-sm pt-6 border-t border-zinc-200 dark:border-zinc-800">
              ...
              <div className="flex justify-between items-center text-zinc-600 dark:text-zinc-400">
                ...
                <span className="font-medium text-zinc-900 dark:text-zinc-100">
                  {formatCurrency(result.tasseStimate)}
                </span>
              </div>
              <div className="flex justify-between items-center text-zinc-600 dark:text-zinc-400">
                <span>INPS</span>
                <span className="font-medium text-zinc-900 dark:text-zinc-100">
                  {formatCurrency(result.inpsStimato)}
                </span>
              </div>
              <div className="flex justify-between items-center text-zinc-600 dark:text-zinc-400">
                <span>Costi Forfettari</span>
                <span className="font-medium text-zinc-900 dark:text-zinc-100">
                  {formatCurrency(result.costiForfettari)}
                </span>
              </div>
            </div>

            <p className="text-xs text-zinc-500 mt-6 leading-relaxed">
              * I calcoli sono approssimati e non tengono conto di eventuali contributi pregressi o
              deduzioni extra.
            </p>
          </div>
        </motion.div>
