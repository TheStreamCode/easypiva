          ...
          <div className="flex flex-col gap-6">
            <div className="space-y-3">
              <div className="space-y-1">
                <Label htmlFor="redditoLordo" className="text-zinc-700 dark:text-zinc-300">
            ...
            <div className="flex flex-col gap-4 text-sm">
              <div className="flex justify-between items-center text-zinc-600 dark:text-zinc-400">
                ...
                <span className="font-medium text-zinc-900 dark:text-zinc-100">
                  {formatCurrency(result.fisso)}
                </span>
              </div>
              <div className="flex justify-between items-center text-zinc-600 dark:text-zinc-400">
                <span>Contributo Variabile (Eccedenza)</span>
                <span className="font-medium text-zinc-900 dark:text-zinc-100">
                  {formatCurrency(result.variabile)}
                </span>
              </div>
            ...
            {(tipoInps === 'artigiani' || tipoInps === 'commercianti') && (
              <div className="pt-6 border-t border-zinc-200 dark:border-zinc-800">
                ...
                <p className="text-xs text-zinc-500 mt-6 leading-relaxed">
                  * I contributi variabili si pagano con il saldo e gli acconti delle imposte
                  (Giugno/Novembre).
                </p>
              </div>
            )}
            ...
            {tipoInps === 'gestioneSeparata' && (
              <div className="pt-6 border-t border-zinc-200 dark:border-zinc-800">
                <p className="text-sm text-zinc-600 dark:text-zinc-400 leading-relaxed">
                  La Gestione Separata non ha rate fisse. Si paga in percentuale sul reddito
                  effettivo tramite saldo e acconti (Giugno/Novembre).
                </p>
              </div>
            )}
          </div>
