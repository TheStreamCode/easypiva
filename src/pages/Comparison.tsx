      ...
      >
        <motion.div variants={itemVariants} className="lg:col-span-1 flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-6">
            <div className="space-y-3">
              <Label htmlFor="ricavi" className="text-zinc-700 dark:text-zinc-300">
            ...
            <div className="space-y-3">
              <div className="space-y-1">
                <Label htmlFor="costiReali" className="text-zinc-700 dark:text-zinc-300">
                  Costi Reali Annui (€)
                </Label>
            ...
            <div className="flex items-center justify-between py-4 border-y border-zinc-200 dark:border-zinc-800">
              <Label htmlFor="nuovaAttivita" className="text-zinc-700 dark:text-zinc-300">
                Nuova Attività (5%)
              </Label>
              <Switch
                id="nuovaAttivita"
        ...
        <motion.div variants={itemVariants} className="lg:col-span-2 flex flex-col gap-12">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-zinc-600 dark:text-zinc-400">
                ...
                <span className="font-medium text-zinc-900 dark:text-zinc-100">
                  {formatCurrency(Math.abs(result.deltaNetto))}
                </span>{' '}
                all'anno.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8 border-t border-zinc-200 dark:border-zinc-800">
            <div
              className={`flex flex-col gap-4 p-6 rounded-xl transition-colors ${result.winner === 'forfettario' ? 'bg-zinc-50 dark:bg-zinc-900/50 ring-1 ring-zinc-200 dark:ring-zinc-800' : ''}`}
            >
              ...
              <div className="flex flex-col gap-3 text-sm">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-medium text-zinc-900 dark:text-zinc-100">
                    {formatCurrency(ricavi)}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-zinc-500">Costi Forfettari:</span>
                  <span className="text-zinc-500">-{formatCurrency(result.forfettario.costi)}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-zinc-500">INPS (Stima):</span>
                  <span className="text-zinc-500">-{formatCurrency(result.forfettario.inps)}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-zinc-500">Imposta ({nuovaAttivita ? '5%' : '15%'}):</span>
                  <span className="text-zinc-500">-{formatCurrency(result.forfettario.tasse)}</span>
                </div>
                <div className="h-px bg-zinc-200 dark:bg-zinc-800 my-1" />
                <div className="flex justify-between items-center text-base">
                  <span className="font-medium text-zinc-900 dark:text-zinc-100">Netto:</span>
                  <span className="font-semibold text-zinc-900 dark:text-zinc-100">
                    {formatCurrency(result.forfettario.netto)}
                  </span>
                </div>
              </div>
            </div>
            ...
            <div
              className={`flex flex-col gap-4 p-6 rounded-xl transition-colors ${result.winner === 'ordinario' ? 'bg-zinc-50 dark:bg-zinc-900/50 ring-1 ring-zinc-200 dark:ring-zinc-800' : ''}`}
            >
              <h3 className="text-lg font-medium text-zinc-900 dark:text-zinc-100 border-b border-zinc-200 dark:border-zinc-800 pb-2">
                Regime Ordinario
              </h3>
              <div className="flex flex-col gap-3 text-sm">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-zinc-500">INPS (Stima):</span>
                  <span className="text-zinc-500">-{formatCurrency(result.ordinario.inps)}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-zinc-500">IRPEF + Addizionali:</span>
                  <span className="text-zinc-500">-{formatCurrency(result.ordinario.tasse)}</span>
                </div>
                <div className="h-px bg-zinc-200 dark:bg-zinc-800 my-1" />
                <div className="flex justify-between items-center text-base">
                  <span className="font-medium text-zinc-900 dark:text-zinc-100">Netto:</span>
                  <span className="font-semibold text-zinc-900 dark:text-zinc-100">
                    {formatCurrency(result.ordinario.netto)}
                  </span>
                </div>
              </div>
            </div>
